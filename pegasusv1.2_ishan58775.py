...
# Pegasus v1.2 — ADB Utility Toolkit (password protected, license removed)
...
pw = getpass(Fore.YELLOW + "Enter password to run Pegasus v1.2: ")
if pw != PASSWORD:
